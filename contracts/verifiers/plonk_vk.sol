// Verification Key Hash: 5e355bf91fe3e2bcc2f421ef2b95d0011664ca0e84764db7e9c4884e5c71b125
...
library UltraVerificationKey {
    function verificationKeyHash() internal pure returns (bytes32) {
        return 0x5e355bf91fe3e2bcc2f421ef2b95d0011664ca0e84764db7e9c4884e5c71b125;
    }
    ...
    function loadVerificationKey(uint256 _vk, uint256 _omegaInverseLoc) internal pure {
        assembly {
            ...
            mstore(add(_vk, 0x80), 0x0595256591d22bf1498bddf8bdc896bc5492eaa13df015526515cff3a8706061) // vk.Q1.x
            mstore(add(_vk, 0xa0), 0x09ebfdac621d67fcc8e6cd3260ed1ba367ca4cbac85ed4ed13e7b4a2d8f1ff51) // vk.Q1.y
            mstore(add(_vk, 0xc0), 0x18152855e65ed9be4d759a6802c9df16d17bbc80f71b093a81ca01fba163f4fa) // vk.Q2.x
            mstore(add(_vk, 0xe0), 0x248eee8c604b8e8b696efd14e3165b6b5a424bad877139e281299b5c64d63b78) // vk.Q2.y
            mstore(add(_vk, 0x100), 0x2aaa3ffa60634f0a103b8270d6a8b0cd4cde2f97df8913d5ebff1040c1edb96c) // vk.Q3.x
            mstore(add(_vk, 0x120), 0x0ddd8df2d8c619c2139eb25b75c37ac3607cda4ed7c806a8d94ded59a39c843c) // vk.Q3.y
            mstore(add(_vk, 0x140), 0x0df7018cda5215546fc0944d779674fc7bd7beae0d4f4a134cdfde76015cd01f) // vk.Q4.x
            mstore(add(_vk, 0x160), 0x1c74dd0300532602201b03550e03429382e1dccd85f235dfd7cbe6ad6fa52f5d) // vk.Q4.y
            mstore(add(_vk, 0x180), 0x2e099b2d1940940132626ef6149a574458a07174da95df2e7492de6de7ce628e) // vk.Q_M.x
            mstore(add(_vk, 0x1a0), 0x1f1a6505cc5adf6d849958a86e7c25ccb7a3f0057364d4d6e6ab5f26e01808fe) // vk.Q_M.y
            mstore(add(_vk, 0x1c0), 0x28dccd239b6dd2bfcf18ac65f4e87830aac9d092bb8377ea388ff7a3749d4de2) // vk.Q_C.x
            mstore(add(_vk, 0x1e0), 0x22591a77913db9f14770972662b1093a2ba0abf1f33f86b95d8c3ee22d2224e3) // vk.Q_C.y
            mstore(add(_vk, 0x200), 0x009f53fcc9b3ce3fbda1275667f6fbe6d6c5f4b85290b9c68c2bf1a9f1fee602) // vk.Q_ARITHMETIC.x
            mstore(add(_vk, 0x220), 0x13c9ad3d1052f8e8a13b464446fec76aad5df03a5c837683d8947f2244b817b2) // vk.Q_ARITHMETIC.y
            mstore(add(_vk, 0x240), 0x278b2979e356fe5dfd1072f5962b78749c03a00e511b4ddd7ae98a1ea114d385) // vk.QSORT.x
            mstore(add(_vk, 0x260), 0x19d2fca948e1c4acb617f23e7a6e03e6482fb7c79179481c84caf6820d11214a) // vk.QSORT.y
            ...
            mstore(add(_vk, 0x300), 0x163a014a9d7d5f58e237051ced7ea6000b77ef879a19dd5e5008708264741abc) // vk.SIGMA1.x
            mstore(add(_vk, 0x320), 0x2ceda3041d4f4b0fc227d803093e3b7b6713342e7620771b2b046998dbf7238e) // vk.SIGMA1.y
            mstore(add(_vk, 0x340), 0x11d1e94a17e49ddfab99cd090b442023f62880d70e1298b3053625aa3358e191) // vk.SIGMA2.x
            mstore(add(_vk, 0x360), 0x0c24f4336530649f36cf04b19f7dad0d6d80b0ee9c772857a489d4fdf8305d46) // vk.SIGMA2.y
            mstore(add(_vk, 0x380), 0x09a7381b3c068b34f080dcb44e75bafd8418df3728e9cff576ebba213aeaee47) // vk.SIGMA3.x
            mstore(add(_vk, 0x3a0), 0x01392bee5d4b9676d078c121c4f30319802a423c3e91e1a6d4b728f356264a75) // vk.SIGMA3.y
            mstore(add(_vk, 0x3c0), 0x26ce64a95b31c04db0d38952f7d516251f67fc97cdd288b5ca32c09fe0f5fa62) // vk.SIGMA4.x
            mstore(add(_vk, 0x3e0), 0x17e37ead58bc5acf2d5db469c41bed12c1031234bb7a6817d435f83404ea71f8) // vk.SIGMA4.y
            ...
            mstore(add(_vk, 0x500), 0x162ebd2f8564f4aa0b5700b1131d90f778114370a35ef429532bcb5c6e0d6c3b) // vk.TABLE_TYPE.x
            mstore(add(_vk, 0x520), 0x0a474ef9a38e73c89dc1df748c47fbd4e87c185998100505b6f6c7ff926f8853) // vk.TABLE_TYPE.y
            mstore(add(_vk, 0x540), 0x2d19de365adccdad8984aa575728f77c928a9397f2a4d55f7529fe583d536f2d) // vk.ID1.x
            mstore(add(_vk, 0x560), 0x0cccb01daf22770297149cebecb8461636acdd6a543b937923aafd9d79bc41eb) // vk.ID1.y
            mstore(add(_vk, 0x580), 0x24364003a063cc6202c4868fcf23ffa6cbafc7bdb482fce5f18b2c0bcf3d5756) // vk.ID2.x
            mstore(add(_vk, 0x5a0), 0x140f3131a3bc39173c495f1ec91ca0ea9863f60869f6f575fe9e366acf3a19a9) // vk.ID2.y
            mstore(add(_vk, 0x5c0), 0x22ddfe8420c9ad5fab43c5b8d5d45245bd12741c414139d80e58d163c2326984) // vk.ID3.x
            mstore(add(_vk, 0x5e0), 0x0025cf606f124854241840f37fcbde68ee904c3e86e85e65fc95cb848b395132) // vk.ID3.y
            mstore(add(_vk, 0x600), 0x1c79055c2319d27c5606172c2e06f23763eab52bcfea6977b34867800f094052) // vk.ID4.x
            mstore(add(_vk, 0x620), 0x23fd1d627caf9c6687663ed6b12d0d5236e1f01c0cfb5e44845fa772ff784627) // vk.ID4.y
    ...
    function verify(bytes calldata _proof, bytes32[] calldata _publicInputs) external view returns (bool) {
        ...
        assembly {
             ...
             */
            {
                ...
                result := addmod(
                    ...
                    mulmod(
                        ...
                        mulmod(mload(L_END_LOC), addmod(mload(Z_OMEGA_EVAL_LOC), sub(p, mload(PUBLIC_INPUT_DELTA_LOC)), p), p),
                        p
                    ),
                    p
                )
                ...
                mstore(
                    ...
                    addmod(
                        result,
                        mulmod(mload(C_ALPHA_BASE_LOC), mulmod(mload(L_START_LOC), addmod(mload(Z_EVAL_LOC), sub(p, 1), p), p), p),
                        p
                    )
                )
                mstore(C_ALPHA_BASE_LOC, mulmod(mload(C_ALPHA_BASE_LOC), mload(C_ALPHA_LOC), p))
             ...
             */
            {
                ...
                f := addmod(f, addmod(mload(W3_EVAL_LOC), mulmod(mload(QC_EVAL_LOC), mload(W3_OMEGA_EVAL_LOC), p), p), p)
                f := mulmod(f, mload(C_ETA_LOC), p)
                f := addmod(f, addmod(mload(W2_EVAL_LOC), mulmod(mload(QM_EVAL_LOC), mload(W2_OMEGA_EVAL_LOC), p), p), p)
                f := mulmod(f, mload(C_ETA_LOC), p)
                f := addmod(f, addmod(mload(W1_EVAL_LOC), mulmod(mload(Q2_EVAL_LOC), mload(W1_OMEGA_EVAL_LOC), p), p), p)
             ...
             */
            {
                ...
                let identity := addmod(mload(QC_EVAL_LOC), addmod(w4q3, addmod(w3q3, addmod(w2q2, addmod(w1q1, w1w2qm, p), p), p), p), p)
                ...
                let extra_small_addition_gate_identity := mulmod(
                    ...
                    mulmod(
                        ...
                        addmod(
                            mload(QM_EVAL_LOC),
                            addmod(sub(p, mload(W1_OMEGA_EVAL_LOC)), addmod(mload(W1_EVAL_LOC), mload(W4_EVAL_LOC), p), p),
                            p
                        ),
                        p
                    ),
             ...
             */
            {
                ...
                let range_accumulator := mulmod(
                    mulmod(mulmod(addmod(mulmod(d1, d1, p), sub(p, d1), p), addmod(d1, minus_two, p), p), addmod(d1, minus_three, p), p),
                    mload(C_ALPHA_BASE_LOC),
                    p
                )
             ...
             */
            {
                ...
                leftovers := addmod(
                    leftovers,
                    mulmod(mulmod(mload(X1_EVAL_LOC), mload(X1_EVAL_LOC), p), addmod(mload(X3_EVAL_LOC), mload(X1_EVAL_LOC), p), p),
                    p
                )
                leftovers := addmod(
                    leftovers,
                    sub(p, addmod(mulmod(mload(Y2_EVAL_LOC), mload(Y2_EVAL_LOC), p), mulmod(mload(Y1_EVAL_LOC), mload(Y1_EVAL_LOC), p), p)),
                    p
                )
                ...
                endo_term := mulmod(mulmod(mload(X2_EVAL_LOC), mload(QBETA_LOC), p), addmod(mload(Y3_EVAL_LOC), mload(Y1_EVAL_LOC), p), p)
                sign_term := sub(
                    p,
                    mulmod(mulmod(mload(Y2_EVAL_LOC), mload(QSIGN_LOC), p), addmod(mload(X1_EVAL_LOC), sub(p, mload(X3_EVAL_LOC)), p), p)
                )
                leftovers := addmod(
            ...
            {
                {
                    ...
                    let non_native_field_gate_2 := addmod(
                        addmod(mulmod(mload(W1_EVAL_LOC), mload(W4_EVAL_LOC), p), mulmod(mload(W2_EVAL_LOC), mload(W3_EVAL_LOC), p), p),
                    ...
                    limb_subproduct := addmod(limb_subproduct, mulmod(mload(W1_OMEGA_EVAL_LOC), mload(W2_OMEGA_EVAL_LOC), p), p)
...

                {
                    ...
                    let adjacent_values_match_if_adjacent_indices_match := mulmod(record_delta, addmod(1, sub(p, index_delta), p), p)
...

                    {
                        ...
                        let adjacent_values_match_if_adjacent_indices_match_and_next_access_is_a_read_operation := mulmod(
...

                    {
                        ...
                        memory_identity := addmod(memory_identity, mulmod(RAM_timestamp_check_identity, mload(Q4_EVAL_LOC), p), p)
                        memory_identity := addmod(memory_identity, mulmod(mload(AUX_MEMORY_EVALUATION), mload(QM_EVAL_LOC), p), p)
                ...
                mstore(
                    ...
                    mulmod(
                        addmod(
                            addmod(
                                addmod(
                                    addmod(addmod(mload(PERMUTATION_IDENTITY), mload(PLOOKUP_IDENTITY), p), mload(ARITHMETIC_IDENTITY), p),
                                    mload(SORT_IDENTITY),
                                    p
                                ),
             ...
             */
            {
                ...
                batch_evaluation := addmod(
                    batch_evaluation,
                    mulmod(mload(C_V1_LOC), addmod(mulmod(mload(W2_OMEGA_EVAL_LOC), mload(C_U_LOC), p), mload(W2_EVAL_LOC), p), p),
                    p
                )
                batch_evaluation := addmod(
                    batch_evaluation,
                    mulmod(mload(C_V2_LOC), addmod(mulmod(mload(W3_OMEGA_EVAL_LOC), mload(C_U_LOC), p), mload(W3_EVAL_LOC), p), p),
                    p
                )
                batch_evaluation := addmod(
                    batch_evaluation,
                    mulmod(mload(C_V3_LOC), addmod(mulmod(mload(W4_OMEGA_EVAL_LOC), mload(C_U_LOC), p), mload(W4_EVAL_LOC), p), p),
                    p
                )
                batch_evaluation := addmod(
                    batch_evaluation,
                    mulmod(mload(C_V4_LOC), addmod(mulmod(mload(S_OMEGA_EVAL_LOC), mload(C_U_LOC), p), mload(S_EVAL_LOC), p), p),
                    p
                )
                batch_evaluation := addmod(
                    batch_evaluation,
                    mulmod(mload(C_V5_LOC), addmod(mulmod(mload(Z_OMEGA_EVAL_LOC), mload(C_U_LOC), p), mload(Z_EVAL_LOC), p), p),
                    p
                )
                batch_evaluation := addmod(
                    batch_evaluation,
                ...
                batch_evaluation := addmod(
                    batch_evaluation,
                    mulmod(mload(C_V21_LOC), addmod(mulmod(mload(TABLE1_OMEGA_EVAL_LOC), mload(C_U_LOC), p), mload(TABLE1_EVAL_LOC), p), p),
                    p
                )
                batch_evaluation := addmod(
                    batch_evaluation,
                    mulmod(mload(C_V22_LOC), addmod(mulmod(mload(TABLE2_OMEGA_EVAL_LOC), mload(C_U_LOC), p), mload(TABLE2_EVAL_LOC), p), p),
                    p
                )
                batch_evaluation := addmod(
                    batch_evaluation,
                    mulmod(mload(C_V23_LOC), addmod(mulmod(mload(TABLE3_OMEGA_EVAL_LOC), mload(C_U_LOC), p), mload(TABLE3_EVAL_LOC), p), p),
                    p
                )
                batch_evaluation := addmod(
                    batch_evaluation,
                    mulmod(mload(C_V24_LOC), addmod(mulmod(mload(TABLE4_OMEGA_EVAL_LOC), mload(C_U_LOC), p), mload(TABLE4_EVAL_LOC), p), p),
                    p
                )
